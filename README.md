NOTE: This repository isn't fully complete.
...
navigation using sensor fusion techniques within a mock smart city that we built from scratch. 
 ...
 for lanes and traffic signs. Real-time lane segmentation feeds are directly sourced from the ZED2 RGB-D data. 
...
* Real-time lane segmentation for lane following
